package games.guardSlalom.nicotesting;
...
public class Link {
	...
	public void update(GameContainer arg1, StateBasedGame arg2, int arg3) {
		...
		if ((guard.getArea().contains(player.getCenterX(), player.getCenterY()))&&(!wall)&&(games.guardSlalom.util.Collisions.distance(player.getCenter(), guard.getCenter())<400)){
			guard.showAlert();
