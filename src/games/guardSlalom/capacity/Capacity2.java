package games.guardSlalom.capacity;
...
public class Capacity2 {
	...
	public Capacity2(String typeCapacity){
		if (typeCapacity=="couteau"){
			this.duration=5;
			this.image=AppLoader.loadPicture("/images/guardSlalom/bonuses/knife.png");
			this.name="couteau";
		...
		if (typeCapacity=="pistolet"){
			this.duration=5;
			this.image=AppLoader.loadPicture("/images/guardSlalom/bonuses/gun.png");
			this.name="pistolet";
		...
		if (typeCapacity=="radar"){
			this.duration=5;
			this.image=AppLoader.loadPicture("/images/guardSlalom/bonuses/radar.png");
			this.name="couteau";
